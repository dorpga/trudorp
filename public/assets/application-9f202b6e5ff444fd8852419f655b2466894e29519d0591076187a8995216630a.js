...
(function() {
  ...
  document.addEventListener('turbolinks:before-cache', function() {
    return document.querySelectorAll('*[uk-icon] > svg').forEach(function(elem) {
      return elem.remove();
    });
  });

  $(document).on("turbolinks:load", function() {
    return document.querySelectorAll('[data-slug]').forEach(function(i) {
      return i.addEventListener('change', function() {
        return document.getElementById(i.getAttribute('data-slug')).value = slugify(i.value);
      });
    });
  });
